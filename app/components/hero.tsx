...
const profile = {
    ...
    skills: [
        'React', 'NextJS', 'Redux', 'Express', 'ElectronJS'
        'MySQL', 'PostgreSQL' 'MongoDB', 'TypeScript',
        'GraphQL', 'Git', 'Linux'
    ],
    hardWorker: true,
    quickLearner: true,
          ...
          <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10 py-12 lg:py-0">
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/TeaTea-1611"
              ...
              {/* Floating badges */}
              <div className="hidden lg:block absolute left-[7.5rem] top-[2.5rem] animate-float-slow">
              ...
              <div className="hidden lg:block absolute top-[13rem] left-[70%] transform -translate-x-1/2 animate-float">
